...
import com.apache.mina.client.util.NetworkUtil;
...
public class PushManager {
	...
	public void setPushEventListener(PushEventListener pushEventListener) {
		if (connector != null && connector.getHandler() != null) {
			if (connector.getHandler() instanceof ClientSessionHandler) {
				((ClientSessionHandler) connector.getHandler())
						.setPushEventListener(pushEventListener);
			}
		}
	...
	public boolean Connect() {
		...
		if (connector != null && connector.isActive() && connectFuture != null
				&& connectFuture.isConnected() && session != null
				&& session.isConnected()) {
			return true;
		}
